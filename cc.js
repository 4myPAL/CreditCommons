	    ...
	    function login() {	  
				...
				var member = creditCommons.getMember(coinbase);
					...
					var group = creditCommons.getGroup(myGroupID);
						...
						var open = group[6];
				document.getElementById('me').innerHTML = "ETH Account: <b>" + coinbase + "<br></b> Credit Commons Member: <b>" + isMember + "</b> Alias: <b>" + myAlias + "<br></b>Group ID: <b>" + myGroupID + "</b>";
				document.getElementById('balance').innerText = myBalance + " " + currencyName;
				document.getElementById('debitLimit').innerText = myDebitLimit + " " + currencyName;
				document.getElementById('ceditLimit').innerText = myCreditLimit + " " + currencyName;
				...
				document.getElementById('debitLimitG').innerText = debitLimit + " " + currencyName;
				document.getElementById('creditLimitG').innerText = creditLimit + " " + currencyName;
		}
